  ...
  return (
    <>
      <p>
        ...
        что <a href="/ru/docs/widgets/filter-bar">FilterBar</a> даёт кликам по полям,
...
падает                свободное слово — по тексту`}
  ...
  stringifyQuery, // условия → строка (для ссылок и пресетов)
        ...
        <p>
          ...
          <a href="/ru/docs/components/time-range">TimeRangePicker</a>: <code>due:&lt;now+7d</code> работает
          из коробки.
        </p>
      </Section>
    </>
